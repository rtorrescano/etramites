        	...
        	<div class="bottom-buffer"></div>
      		<div class="container">
				...
				<div class="row" ng-init="stage01 = true; section01 = true">
					<div class="col-sm-12">
						<ul class="wizard-steps">
							<li class="completed">
								<h5>Paso 1</h5><span>Generales</span>
							</li>
							<li class="completed">
								<h5>Paso 2</h5><span>Entregables</span>
							</li>
							<li class="completed">
								<h5>Paso 3</h5><span>Total de inversi&oacute;n</span>
							</li>
							<li class="completed">
								<h5>Paso 4</h5><span>Documentos</span>
							</li>
							<li class="success">
				...
				<cfquery name="folio" datasource="etramites">
					select count(*) as total from folio
				</cfquery>
				...
				<cfquery name="folio" datasource="etramites">
					insert into folio( id_registro, folio, fecha_registro)
					values('#url.id_user#','SE-FO-06-018-#ceros##consecutivo#', #hoy#)
				</cfquery>
				...
				<CFMAIL FROM="comunicados.prosoft@economia.gob.mx"		
					...
					port="25"
					SUBJECT="Registro de Reporte de avance y/o final del apoyo del programa para el desarrollo de la industria de software (PROSOFT) y la innovación"
					type="text/HTML">
					<body bgcolor="##F3F3F3">
						<section>
	          				<div class="row"></div>
	          				<div class="row">
	          					...
	          					<div class="col-sm-8">
	          						...
	          						<div class="col-sm-5">
	          							...
	          							<p style="font-family:Arial; font-size:16px">El folio de seguimiento <strong>SE-FO-06-018-#ceros##consecutivo#</strong> se envi&oacute; correctamente</p>	          							
	          						</div>
	          						<div class="col-sm-1"></div>
	          						<div class="row" bgcolor="##621132">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="alert alert-success">
							<p>El folio de seguimiento <strong>SE-FO-06-018-#ceros##consecutivo#</strong> se envi&oacute; correctamente</p>
