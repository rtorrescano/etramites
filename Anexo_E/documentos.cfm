...
<cfif consulta.recordcount gt 0>
	<cfset archivo1='#consulta.certificado#'>
	<cfset archivo2='#consulta.curricula#'>
	<cfset archivo3='#consulta.formato#'>
	<cfset boton=1>
<cfelse>
	<cfset archivo1=''>
	<cfset archivo2=''>
    	...
    	<main class="page">
        	<div class="bottom-buffer"></div>
      		<div class="container">
				...
				<div class="row">
			        <div class="col-sm-12">
              			<form name="registro" action="documentos_action.cfm" method="post" enctype="multipart/form-data" role="form">
							...
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group">
										<label class="control-label">Certificado de calidad del proveedor (si aplica)<span class="form-text">*</span>:</label>
										<input class="form-control ng-scope" id="archivo1" name="archivo1" type="file" accept="application/pdf,application/zip" <cfif #consulta.certificado# gt 0> <cfelse>required</cfif>>
										<div class="help-block with-errors"></div>
										<cfif #consulta.certificado# gt 0>
                    						<a href="#consulta.ruta#/#consulta.certificado#">Consulta documento adjunto aqu&iacute;</a>
                  						</cfif>
									</div>
								</div>	
							</div>
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group">
										<label class="control-label">Curr&iacute;cula de proveedor <span class="form-text">*</span>:</label>
										<input class="form-control ng-scope" id="archivo2" name="archivo2" type="file" accept="application/pdf,application/zip" <cfif #consulta.curricula# gt 0> <cfelse>required</cfif>>
										<div class="help-block with-errors"></div>
										<cfif #consulta.curricula# gt 0>
                    						<a href="#consulta.ruta#/#consulta.curricula#">Consulta documento adjunto aqu&iacute;</a>
                  						</cfif>
									</div>
								</div>	
							</div>
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group">
										<label class="control-label">Formato impreso de solicitud<span class="form-text">*</span>:</label>
										<input class="form-control ng-scope" id="archivo3" name="archivo3" type="file" accept="application/pdf,application/zip" <cfif #consulta.formato# gt 0> <cfelse>required</cfif>>
										<div class="help-block with-errors"></div>
										<cfif #consulta.formato# gt 0>
                    						<a href="#consulta.ruta#/#consulta.formato#">Consulta documento adjunto aqu&iacute;</a>
                  						</cfif>
									</div>
								</div>	
							</div>
